...
## Goal
Implement three endings with distinct pacing and conditions. Prestige is not a hard requirement but should make these endings realistically attainable.

## How To Use This Project File
- This file is the master checklist for Milestone 3.
...
## Subprojects
- `projects/3/subprojects/subproject-1.md` — Ending conditions + run state
- `projects/3/subprojects/subproject-2.md` — Ending UI + summaries
- `projects/3/subprojects/subproject-3.md` — Balance and pacing checks
...
- [ ] Smoke test: reach each ending, verify summaries
