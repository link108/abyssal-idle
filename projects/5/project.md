# Milestone 5 — Collections Page

## Goal
Implement a data-driven Collections Page with category navigation, discovered/undiscovered placeholders, detail panels, and persistence across prestiges.

## How To Use This Project File
- This file is the master checklist for Milestone 5.
...
## Subprojects
- `projects/5/subproject-1.md` — Collections UI shell + category navigation
- `projects/5/subproject-2.md` — Fish collection grid + detail panel
- `projects/5/subproject-3.md` — Recipe collection grid + detail panel
- `projects/5/subproject-4.md` — Persistence, stats tracking, and integration polish
