...
## Goal
Expand the permanent tech tree with industrial, sustainability, and meta branches while preserving early-game feel.

## How To Use This Project File
- This file is the master checklist for Milestone 4.
...
## Subprojects
- `projects/4/subprojects/subproject-1.md` — Skill tree data model + pairing rules
- `projects/4/subprojects/subproject-2.md` — Skill tree UI + UX
- `projects/4/subprojects/subproject-3.md` — Apply bonuses and balance
